...
public class ClienteDao {
    ...
    public void atualizarCliente(Integer i,  Cliente novosDadosCliente) {
    ...
    public void deletarCliente(Integer idDeletar) {
        String sql = "DELETE FROM cliente WHERE id=?";
        try {
            // Verifica se existem locações associadas a este cliente
            if (possuiLocacoes(idDeletar)) {
                // Se existirem locações, primeiro exclui as locações do cliente
